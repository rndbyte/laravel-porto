...
@section('page_title') 404 page not found @stop
@section('content')
    <div class="h-screen w-screen bg-gray-100 flex items-center" id="app">
        <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
            <div class="max-w-xl">
                <div class="text-5xl font-dark font-bold">404</div>
                <p class="text-2xl md:text-2xl font-light leading-normal">
            ...
            <div class="max-w-xl">
                <svg id="Layer_1"
                     ...
                     viewBox="0 0 2395 1800" width="400">
                    <defs>
                        <style>
                            .cls-1 {
                                fill: #d6b49a;
